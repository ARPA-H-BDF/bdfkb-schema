# Contributing to bdfkb-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
bdfkb-schema. These guidelines are not strict rules.
...
The bdfkb-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the bdfkb-schema technical leads
...
[issues]: https://github.com/ARPA-H-BDF/bdfkb-schema/issues/
[pulls]: https://github.com/ARPA-H-BDF/bdfkb-schema/pulls/
