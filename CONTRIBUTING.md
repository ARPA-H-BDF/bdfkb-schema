# Contributing to bdf-toolbox-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
bdf-toolbox-schema. These guidelines are not strict rules.
...
The bdf-toolbox-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the bdf-toolbox-schema technical leads
...
[issues]: https://github.com/ARPA-H-BDF/bdf-toolbox-schema/issues/
[pulls]: https://github.com/ARPA-H-BDF/bdf-toolbox-schema/pulls/
